...
public class Restaurante {
    ...
    private double calcularPrecioPlato(String nombrePlato) {
        // Ejemplo de precios ficticios para los platos
        return switch (nombrePlato.toLowerCase()) {
            case "Vaso de Duraznos" -> 20.000;
            case "Ensalada de frutas" -> 15.000;
            case "Cono basico" -> 5.000;
            default -> 0.0;
        };
        }
        }